...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        if not swapper.is_swapped('vera', 'Site'):
            ...
            db.send_create_signal('vera', ['Site'])
        ...
        if not swapper.is_swapped('vera', 'Event'):
            ...
            db.send_create_signal('vera', ['Event'])
        ...
        if not swapper.is_swapped('vera', 'Report'):
            ...
            db.create_table('wq_report', (
                ...
                ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='vera_report', null=True, to=User)),
                ('status', self.gf('django.db.models.fields.related.ForeignKey')(to=ReportStatus, null=True, blank=True)),
            ))
            db.send_create_signal('vera', ['Report'])
        ...
        if not swapper.is_swapped('vera', 'ReportStatus'):
            ...
            db.send_create_signal('vera', ['ReportStatus'])
        ...
        if not swapper.is_swapped('vera', 'Parameter'):
            ...
            db.send_create_signal('vera', ['Parameter'])
        ...
        if not swapper.is_swapped('vera', 'Result'):
            ...
            db.send_create_signal('vera', ['Result'])
    ...
    models = {
        ...
        'vera.event': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vera.Site']", 'null': 'True', 'blank': 'True'})
        },
        'vera.eventresult': {
            'Meta': {'unique_together': "(('event', 'result_type'),)", 'object_name': 'EventResult', 'db_table': "'wq_eventresult'"},
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vera.Event']"}),
            'event_date': ('django.db.models.fields.DateField', [], {}),
            'event_site': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vera.Site']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.PositiveIntegerField', [], {'primary_key': 'True'}),
            'result': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vera.Result']"}),
            'result_empty': ('django.db.models.fields.BooleanField', [], {}),
            'result_report': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vera.Report']"}),
            'result_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vera.Parameter']"}),
        ...
        'vera.report': {
            ...
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vera.Event']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'status': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vera.ReportStatus']", 'null': 'True', 'blank': 'True'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'vera_report'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'vera.reportstatus': {
        ...
        'vera.result': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'report': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'results'", 'to': "orm['vera.Report']"}),
            'type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vera.Parameter']"}),
