...
const config = {
    ...
    markdown: {
        getEditUrl({ page_config, item_id }) {
            return `https://github.com/wq/django-data-wizard/edit/main/docs/${page_config.url}/${item_id}.md`;
        },
        getNewUrl({ page_config }) {
            return `https://github.com/wq/django-data-wizard/new/main/docs/${page_config.url}`;
        },
    },
    material: {
        theme: {
